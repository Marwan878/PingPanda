    ...
    <div className="bg-brand-25 py-24 sm:py-32">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 mx-auto text-base/7 text-gray-600 max-w-prose text-center text-pretty">
        ...
        <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base/7 text-gray-600">
              ...
              a beat in your buisness growth.
            </p>
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
