...
const Page = () => {
  const codeSnippet = `await fetch("https://extraordinary-platypus-efc01f.netlify.app/api/v1/events", {
    method: "POST",
    body: JSON.stringify({
      category: "sale",
      fields: {
      ...
      <section className="relative bg-brand-25 pb-4">
        ...
        <div className="relative mx-auto">
          <MaxWidthWrapper className="relative">
            <div className="-m-2 roudned-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
              <MockDiscordUI>
                <AnimatedList>
                  <DiscordMessage
                    ...
                    username="PingPanda"
                    timeStamp="Today at 12:35 A.M."
                    badgeColor="#43b581"
                    badgeText="SignUp"
                    title="👤 New user signed up"
                    content={{
                      name: "Ahmed Mohammed",
                      email: "a.mohammed9@gmail.com",
                    }}
                  />
                  <DiscordMessage
                    avatarSrc="/brand-asset-profile-picture.png"
                    avatarAlt="PingPanda avatar."
                    username="PingPanda"
                    timeStamp="Today at 8:59 P.M."
                    badgeColor="#faa61a"
                    badgeText="Revenue"
                    title="💰 Payment received"
                    content={{
                      amount: "$493.56",
                      email: "o.hisham1999@gmail.com",
                      plan: "PRO",
                    }}
                  />
                  <DiscordMessage
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-base/7 font-medium tracking-tight text-brand-950 max-lg:text-center">
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="absolute pointer-events-none inset-px rounded-lg shadow ring-1 ring-black/5" />
            </div>
